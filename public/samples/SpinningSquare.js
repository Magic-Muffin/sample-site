...
Main.prototype = $extend(hxd_App.prototype,{
	init: function() {
		this.obj = new h2d_Object(this.s2d);
		var _this = this.obj;
		...
		var tile = h2d_Tile.fromColor(5579366,100,100);
		tile = tile.center();
		new h2d_Bitmap(tile,this.obj);
		this.onResize();
	}
	,onResize: function() {
		if(this.obj == null) {
...
h2d_Object.prototype = {
	...
	,onRemove: function() {
		...
		var _g = 0;
		var _g1 = this.children;
		while(_g < _g1.length) _g1[_g++].onRemove();
	}
...
h2d_Scene.prototype = $extend(h2d_Layers.prototype,{
	...
	,checkResize: function() {
		...
		case 1:
			var _g1 = _g.height;
			var _g2 = _g.width;
			if(_g2 != _gthis.width || _g1 != _gthis.height) {
				_gthis.width = _g2;
				_gthis.height = _g1;
				_gthis.posChanged = true;
			}
			_gthis.viewportScaleX = engine.width / _g2;
			_gthis.viewportScaleY = engine.height / _g1;
			_gthis.viewportA = 2 / _gthis.width;
			_gthis.viewportD = 2 / _gthis.height;
			_gthis.viewportX = -1;
			_gthis.viewportY = -1;
		...
		case 2:
			...
			var _g3 = _g.height;
			var _g4 = _g.width;
			if(_g4 != _gthis.width || _g3 != _gthis.height) {
				_gthis.width = _g4;
				_gthis.height = _g3;
				_gthis.posChanged = true;
			}
			var a = engine.width / _g4;
			var b = engine.height / _g3;
			var zoom = a > b ? b : a;
			if(_g.integerScale) {
				zoom = zoom | 0;
				if(zoom == 0) {
		...
		case 3:
			...
			var _g4 = _g.height;
			var _g5 = _g.width;
			if(_g5 != _gthis.width || _g4 != _gthis.height) {
				_gthis.width = _g5;
				_gthis.height = _g4;
				_gthis.posChanged = true;
			}
			var horizontal = _g2;
			var vertical = _g1;
			_gthis.viewportA = _g3 * 2 / engine.width;
			_gthis.viewportD = _g3 * 2 / engine.height;
			_gthis.viewportScaleX = _g3;
			_gthis.viewportScaleY = _g3;
			if(_g2 == null) {
				horizontal = h2d_ScaleModeAlign.Center;
			}
			switch(horizontal._hx_index) {
			...
			case 1:
				_gthis.viewportX = 1 - _gthis.width * _gthis.viewportA;
				_gthis.offsetX = engine.width - _gthis.width * _g3;
				break;
			default:
				_gthis.viewportX = Math.floor((engine.width - _gthis.width * _g3) / (_g3 * 2)) * _gthis.viewportA - 1.;
				_gthis.offsetX = Math.floor((engine.width - _gthis.width * _g3) / 2);
			}
			if(_g1 == null) {
				vertical = h2d_ScaleModeAlign.Center;
			}
			...
			case 4:
				_gthis.viewportY = 1 - _gthis.height * _gthis.viewportD;
				_gthis.offsetY = engine.height - _gthis.height * _g3;
				break;
			default:
				_gthis.viewportY = Math.floor((engine.height - _gthis.height * _g3) / (_g3 * 2)) * _gthis.viewportD - 1.;
				_gthis.offsetY = Math.floor((engine.height - _gthis.height * _g3) / 2);
			}
			break;
		case 4:
			var _g1 = _g.level;
			...
			_gthis.viewportScaleX = _g1;
			_gthis.viewportScaleY = _g1;
			_gthis.viewportA = 2 / _gthis.width;
			_gthis.viewportD = 2 / _gthis.height;
			_gthis.viewportX = -1;
			_gthis.viewportY = -1;
...
hxsl_Tools.hasSideEffect = function(e) {
	while(true) {
		...
		case 18:
			...
			if(!hxsl_Tools.hasSideEffect(_g12)) {
				if(_g10 != null) {
					return hxsl_Tools.hasSideEffect(_g10);
				} else {
					return false;
				}
			} else {
		...
		while(g.hasNext()) {
			...
			case 2:
				...
				if(_g11._hx_index == 15) {
					var _g12 = _g11.size;
					var _g13 = _g11.t;
					if(hxsl_Tools.isSampler(_g13)) {
						textures.push({ t : _g13, all : out});
			...
			case 0:
				...
				if(_g3._hx_index == 0) {
					...
					case 2:
						if(_g2._hx_index == 0) {
							var _g3 = _g2.c;
							d = _g3._hx_index == 2 ? hxsl_TExprDef.TConst(hxsl_Const.CInt(_g4.v + _g3.v | 0)) : hxsl_TExprDef.TBinop(_g1,e1,e2);
						} else {
							...
							if(_g4._hx_index == 0) {
								...
								if(_g3._hx_index == 2) {
									...
									if(this.unrollLoops) {
										...
										var _g3 = _g5.v;
										while(_g3 < _g4) {
											this.constants.h[_g2.id] = hxsl_TExprDef.TConst(hxsl_Const.CInt(_g3++));
		...
		case 16:
			...
			if(_g3._hx_index == 1) {
				...
				if(!(_g3._hx_index == 0 && _g3.c._hx_index == 2)) {
					var a = this.varMap.h[_g2.__id__];
					if(a != null) {
						var _g3 = _g2.type;
						if(_g3._hx_index == 15) {
							var _g2 = _g3.t;
							if(hxsl_Tools.isSampler(_g2)) {
								eindex = this.toInt(this.mapExpr(_g1));
								e = this.access(a,_g2,_g,hxsl_ARead.AOffset(a,1,eindex));
							} else {
								...
								stride >>= 2;
								eindex = this.toInt(this.mapExpr(_g1));
								e = this.access(a,_g2,_g,hxsl_ARead.AOffset(a,stride,stride == 1 ? eindex : { e : hxsl_TExprDef.TBinop(haxe_macro_Binop.OpMult,eindex,{ e : hxsl_TExprDef.TConst(hxsl_Const.CInt(stride)), t : hxsl_Type.TInt, p : _g}), t : hxsl_Type.TInt, p : _g}));
							}
						} else {
							throw haxe_Exception.thrown("assert");
						}
	...
	,access: function(a,t,pos,acc) {
		...
		case 7:
			...
			case 1:
				var _g = acc.delta;
				var _g1 = acc.a;
				var index = _g1.t == null ? _g1.pos : _g1.pos >> 2;
				tmp2 = { e : hxsl_TExprDef.TArray({ e : hxsl_TExprDef.TVar(_g1.g), t : _g1.g.type, p : pos},index == 0 ? _g : { e : hxsl_TExprDef.TBinop(haxe_macro_Binop.OpAdd,_g,{ e : hxsl_TExprDef.TConst(hxsl_Const.CInt(index)), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TVec(4,_g1.t), p : pos};
				break;
			}
			var tmp3;
			switch(acc._hx_index) {
			...
			case 1:
				var _g = acc.delta;
				var _g1 = acc.a;
				var index = (_g1.t == null ? _g1.pos : _g1.pos >> 2) + 1;
				tmp3 = { e : hxsl_TExprDef.TArray({ e : hxsl_TExprDef.TVar(_g1.g), t : _g1.g.type, p : pos},index == 0 ? _g : { e : hxsl_TExprDef.TBinop(haxe_macro_Binop.OpAdd,_g,{ e : hxsl_TExprDef.TConst(hxsl_Const.CInt(index)), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TVec(4,_g1.t), p : pos};
				break;
			}
			var tmp4;
			switch(acc._hx_index) {
			...
			case 1:
				var _g = acc.delta;
				var _g1 = acc.a;
				var index = (_g1.t == null ? _g1.pos : _g1.pos >> 2) + 2;
				tmp4 = { e : hxsl_TExprDef.TArray({ e : hxsl_TExprDef.TVar(_g1.g), t : _g1.g.type, p : pos},index == 0 ? _g : { e : hxsl_TExprDef.TBinop(haxe_macro_Binop.OpAdd,_g,{ e : hxsl_TExprDef.TConst(hxsl_Const.CInt(index)), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TVec(4,_g1.t), p : pos};
				break;
			}
			var tmp5;
			switch(acc._hx_index) {
			...
			case 1:
				var _g = acc.delta;
				var _g1 = acc.a;
				var index = (_g1.t == null ? _g1.pos : _g1.pos >> 2) + 3;
				tmp5 = { e : hxsl_TExprDef.TArray({ e : hxsl_TExprDef.TVar(_g1.g), t : _g1.g.type, p : pos},index == 0 ? _g : { e : hxsl_TExprDef.TBinop(haxe_macro_Binop.OpAdd,_g,{ e : hxsl_TExprDef.TConst(hxsl_Const.CInt(index)), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TVec(4,_g1.t), p : pos};
				break;
			}
			...
			if(_g._hx_index == 0) {
				...
				if(hxsl_Tools.isSampler(t)) {
					...
					case 1:
						...
						var _g1 = acc.a;
						var index = _g1.t == null ? _g1.pos : _g1.pos >> 2;
						e = { e : hxsl_TExprDef.TArray({ e : hxsl_TExprDef.TVar(_g1.g), t : _g1.g.type, p : pos},index == 0 ? _g : { e : hxsl_TExprDef.TBinop(haxe_macro_Binop.OpAdd,_g,{ e : hxsl_TExprDef.TConst(hxsl_Const.CInt(index)), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TInt, p : pos}), t : hxsl_Type.TVec(4,_g1.t), p : pos};
						break;
					}
					e.t = t;
					return e;
...
hxsl_GlslOut.prototype = {
	...
	,addExpr: function(e,tabs) {
		...
		case 1:
			...
			break;
		case 2:
			var v = hxsl_GlslOut.GLOBALS.get(_g.g);
			this.buf.b += Std.string(v);
			break;
		case 3:
			this.buf.b += "(";
		...
		case 5:
					...
					if(_g5.size == 3) {
						if(_g5.t._hx_index == 1) {
							if(_g4._hx_index == 8) {
								...
								this.addValue(_g2,tabs);
								this.buf.b += " ";
								this.buf.b += Std.string(hxsl_Printer.opStr(_g3));
								this.buf.b += " ";
								this.addValue(_g1,tabs);
							}
						} else {
			...
			case 5:
				if(_g5._hx_index == 5) {
					if(_g4._hx_index == 5) {
						this.buf.b += Std.string("vec" + _g5.size + "(");
						var v;
						switch(_g3._hx_index) {
						case 5:
							v = "equal";
		...
		case 7:
			var _g1 = _g.init;
			var _g2 = _g.v;
			this.locals.h[_g2.id] = _g2;
			if(_g1 != null) {
				var v = this.varName(_g2);
				this.buf.b += Std.string(v);
				this.buf.b += " = ";
				this.addValue(_g1,tabs);
			} else {
		...
		case 8:
			...
			if(_g3._hx_index == 2) {
				...
				switch(_g4._hx_index) {
				case 35:
					var v = this.getFunName(_g4,_g1,e.t);
					this.buf.b += Std.string(v);
					this.buf.b += "(";
					this.addValue(_g1[0],tabs);
					this.buf.b += ", ";
					this.addValue(_g1[1],tabs);
					if(_g1.length != 2) {
						this.buf.b += ", ";
						this.addValue(_g1[2],tabs);
						this.buf.b += ")";
					} else {
						this.buf.b += ", 0)";
					}
				...
				case 53:
					if(_g1.length == 1) {
						...
						var _g3 = _g2.e;
						if(_g3._hx_index == 2) {
							var v = this.getFunName(_g3.g,_g1,e.t);
							this.buf.b += Std.string(v);
						} else {
							this.addValue(_g2,tabs);
						}
		...
		case 9:
			...
			if(_g2.t._hx_index == 3) {
				var _g3 = 0;
				while(_g3 < _g1.length) if(_g1[_g3++] != hxsl_Component.X) {
					throw haxe_Exception.thrown("assert");
				}
				switch(_g1.length) {
				case 1:
...
hxsl_Linker.prototype = {
		...
		if(_g1._hx_index == 13) {
			...
			if(_g._hx_index == 13) {
				...
				while(_g < _g2.length) {
					...
					if(ft == null) {
						_g1.push(this.allocVar(f1,p,shaderName).v);
					} else {
	...
	,allocVar: function(v,p,shaderName,path,parent) {
		...
		if(v2 != null) {
			...
			var tmp;
			if(!(v.kind == hxsl_VarKind.Param && !hxsl_Tools.hasBorrowQualifier(v2.v,shaderName) && !hxsl_Tools.hasQualifier(v,hxsl_VarQualifier.Shared) && !_gthis.isBatchShader || v.kind == hxsl_VarKind.Function || (v.kind == hxsl_VarKind.Var || v.kind == hxsl_VarKind.Local) && hxsl_Tools.hasQualifier(v,hxsl_VarQualifier.Private))) {
				var v1 = v2.v;
				tmp = v1.kind == hxsl_VarKind.Param && !hxsl_Tools.hasBorrowQualifier(v,v2.rootShaderName) && !hxsl_Tools.hasQualifier(v1,hxsl_VarQualifier.Shared) && !_gthis.isBatchShader || v1.kind == hxsl_VarKind.Function || (v1.kind == hxsl_VarKind.Var || v1.kind == hxsl_VarKind.Local) && hxsl_Tools.hasQualifier(v1,hxsl_VarQualifier.Private);
			} else {
				tmp = true;
			}
	...
	,link: function(shadersData) {
		...
		while(_g < _g1.length) {
			...
			while(v1.hasNext()) addVar(v1.next());
			var v2 = s.write.iterator();
			while(v2.hasNext()) addVar(v2.next());
		}
		var cleanVar = null;
		cleanVar = function(v) {
			var _g = v.type;
	...
	,addVar: function(v,defKind,tabs,parent) {
		...
		if(v.qualifiers != null) {
			...
			while(_g < _g1.length) {
				...
				case 6:
					var _g3 = q.p;
					v1 = $hxEnums[_g3.__enum__].__constructs__[_g3._hx_index].toLowerCase() + "p";
					break;
				case 7:
